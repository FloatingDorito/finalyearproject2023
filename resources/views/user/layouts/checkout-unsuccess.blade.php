            ...
            <div class="d-flex flex-center w-lg-50 p-10">
                <div class="card rounded-3 w-md-550px">
                    <div class="card-body p-10 p-lg-20 d-flex flex-column flex-center">
                        <h1 class="fw-bolder text-gray-900 mb-5">Payment Unsuccessful</h1>
                        <div class="fs-6 fw-semibold text-gray-500 mb-10">
                            View Your Unsuccessful Commission Payments Here
                        </div>
                        <div class="mb-11">
                            <a href="{{ route('user.commissions.unpaid.list', ['username' => auth()->user()->username]) }}"
