<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true"
            ...
            <div class="menu-item">
                <a class="menu-link @if (Route::is('user.chat')) active @endif" href="{{route('user.chat', ['username' => auth()->user()->username])}}">
                    <span class="menu-icon">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1 here show">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link @if (Route::is('user.commissions.ongoing.list')) active @endif" href="{{ route('user.commissions.ongoing.list', ['username' => auth()->user()->username]) }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link @if (Route::is('user.commissions.complete.list')) active @endif" href="{{ route('user.commissions.complete.list', ['username' => auth()->user()->username]) }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
