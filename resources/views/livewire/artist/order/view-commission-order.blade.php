        ...
        <div class="card-header">
            ...
            @if ($order->status == 'approved')
                <div class="card-toolbar">
                    <a href="#" class="btn btn-sm fw-bold btn-primary mb-3 mb-sm-0 me-3">Upload Images</a>
        ...
        <div class="card-body pt-9 pb-0">
            <div class="row mb-2">
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <a class="d-block overlay image-160x" data-fslightbox="lightbox-basic"
                        href="{{ secure_asset('commission/' . $order->commission->coverimage) }}">
                        <!--begin::Image-->
            ...
            <div class="d-flex overflow-auto h-55px">
                <ul
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#commissionTab">Commissions</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-center flex-column py-9 px-6">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-basic"
                                            href="{{ secure_asset('order/' . $orderImage->filelocation) }}">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded image-160x"
                                                style="background-image:url('{{ secure_asset('order/' . $orderImage->filelocation) }}')">
                                            </div>
                                            <!--end::Image-->
